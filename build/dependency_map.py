...
git_mapping = {
    ...
    github_root + "GPUOpen-Tools/isa_spec_manager"         : ["../external/isa_spec_manager",      "v1.2.0"],
    github_root + "GPUOpen-Tools/comgr_utils"              : ["../external/comgr_utils",           "c99b131128d50bca3d76f0a4cde7993cfc947741"],
    ...
    github_root + "microsoft/PixEvents"                    : ["../external/third_party/pix_events","3a7e70dde7bf54f02f9d2e9dd6d3350c6cfb962f"]
}
