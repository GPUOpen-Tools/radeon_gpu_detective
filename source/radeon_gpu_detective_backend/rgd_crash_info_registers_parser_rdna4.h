...
/// @file
/// @brief The crash info registers data - navi4x.
//============================================================================================

#ifndef RGD_CRASH_INFO_REGISTERS_PARSER_RDNA4_H_
#define RGD_CRASH_INFO_REGISTERS_PARSER_RDNA4_H_

#include "rgd_crash_info_registers_parser.h"

class CrashInfoRegistersParserRdna4 : public ICrashInfoRegistersParser
{
public:
        /// @brief Destructor.
        virtual ~CrashInfoRegistersParserRdna4() = default;
...
#endif  // RGD_CRASH_INFO_REGISTERS_PARSER_RDNA4_H_