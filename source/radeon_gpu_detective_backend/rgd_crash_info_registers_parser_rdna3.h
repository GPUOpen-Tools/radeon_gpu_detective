...
/// @file
/// @brief The crash info registers data - navi31.
//============================================================================================

#ifndef RGD_CRASH_INFO_REGISTERS_PARSER_RDNA3_H_
#define RGD_CRASH_INFO_REGISTERS_PARSER_RDNA3_H_

#include "rgd_crash_info_registers_parser.h"

class CrashInfoRegistersParserRdna3 : public ICrashInfoRegistersParser
{
public:
        /// @brief Destructor.
        virtual ~CrashInfoRegistersParserRdna3() = default;
...
#endif  // RGD_CRASH_INFO_REGISTER_PARSER_RDNA3_H_